...
export function ClawLogo({ className = 'w-6 h-6' }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 24 26" fill="none" className={className} aria-hidden="true">
      <path d="M6 24 C3.5 17 5 10 8 3" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
      <path d="M12 25 C10 18 11.5 11 12 3" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
      <path d="M18 24 C20.5 17 19 10 16 3" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
    </svg>
  )
}
...
export function IconChat({ className = 'w-4 h-4' }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v6a2 2 0 01-2 2H6l-4 4V5z" clipRule="evenodd" />
    </svg>
  )
}
...
export function IconPaperclip({ className = 'w-4 h-4' }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path fillRule="evenodd" d="M8 4a3 3 0 00-3 3v4.5a4.5 4.5 0 009 0V7a.75.75 0 011.5 0v4.5a6 6 0 11-12 0V7a4.5 4.5 0 019 0v4.5a1.5 1.5 0 003 0V7a3 3 0 00-3-3z" clipRule="evenodd" />
    </svg>
  )
}
