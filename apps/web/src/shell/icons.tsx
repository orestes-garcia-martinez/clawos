...
export function IconApplications({ className = 'w-4 h-4' }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path
        fillRule="evenodd"
        d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v9a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm-1 6a1 1 0 112 0v3a1 1 0 11-2 0v-3zm5-1a1 1 0 10-2 0v4a1 1 0 102 0v-4z"
        clipRule="evenodd"
      />
    </svg>
  )
...
export function IconTrash({ className = 'w-4 h-4' }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path
        fillRule="evenodd"
...
export function IconDocument({ className = 'w-4 h-4' }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 20 20" fill="currentColor" className={className} aria-hidden="true">
      <path
        fillRule="evenodd"
