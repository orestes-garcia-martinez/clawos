...
- **shared:** add `ScrapeClawEnrichmentWorkerInput`, `ScrapeClawEnrichmentWorkerResult`, `ScrapeClawEnrichedProspectResult`, and `ScrapeClawEnrichmentWarning` interfaces; add enrichment mode to `ScrapeClawWorkerInput` union ([14f8f52](https://github.com/orestes-garcia-martinez/clawos/commit/14f8f52ba429a44beaf7ef0d6cb99d14e54bbcf3))
...
- **shared:** add worker-facing ScrapeClaw research interfaces — ScrapeClawResearchWorkerInput/Result, ScrapeClawProspectDraft, ScrapeClawEvidenceDraft, ScrapeClawResearchProspectResult ([c2f937c](https://github.com/orestes-garcia-martinez/clawos/commit/c2f937cd6f7c5f4446f27ca87842957612532862))
